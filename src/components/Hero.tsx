...
const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Background Gradient */}
      <div id="rot" className="w-max h-20 bg-gray-950 absolute "></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
            ...
            modern technologies. I transform ideas into robust, scalable
          ...
          <div className="flex justify-center space-x-6 mb-16">
            <a
              ...
              target="_blank"
              className="p-3 bg-white dark:bg-gray-800 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-110 group"
            >
